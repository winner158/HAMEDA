...
def get_options(args=None):
    ...
    # Data
    parser.add_argument('--problem', default='lecs', help="The problem to solve, such as hcvrp or lecs default 'lecs'")
    parser.add_argument('--graph_size', type=int, default=20, help="The size of the problem graph")
    parser.add_argument('--batch_size', type=int, default=128, help='Number of instances per batch during training')
    parser.add_argument('--epoch_size', type=int, default=2560, help='Number of instances per epoch during training')
    ...
    parser.add_argument('--shrink_size', type=int, default=3,
